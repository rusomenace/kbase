## Query para buscar un valor en todas las tablas de la base de datos
Cambiar el valor de ```SET  @SearchStr='valorqueseestabuscando' BEGIN``` por el que se necesita encontrar

```
Declare @SearchStr nvarchar(100)

SET  @SearchStr='valorqueseestabuscando' BEGIN
